...
* Youtubeの動画のURLを記述したプレイリストのファイルでもなるだけ再生する仕様にしました
* YoutubeのPlaylistのURLでもなるだけ再生する仕様にしました
* YoutubeのUserのURLでもなるだけ再生する仕様にしました
* Xvideosの動画のURLを記述したプレイリストのファイルでもなるだけ再生しようとしますが、対応してないフォーマットなので再生できません。仕様です
