...
public class CloseOwnerStage extends Stage implements Initializable {
    ...
    public CloseOwnerStage(final ObservableValue<? extends Stage> owner) {
        this.owner = owner;
        ...
        FXMLLoader loader = new FXMLLoader();
        {
            ...
            if (fxml == null) {
                fxml = clazz.getResource(CloseOwnerStage.class.getSimpleName() + ".fxml");
            }
            if (fxml != null) {
