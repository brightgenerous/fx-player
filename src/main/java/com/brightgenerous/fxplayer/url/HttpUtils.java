...
public class HttpUtils {
    ...
    public String execGet(String url) throws IOException {
        return exec(Method.GET, url, userAgent, null, contentType, encode, selfSigned, syncCookie);
    }

    public String execPost(String url, String body) throws IOException {
        return exec(Method.POST, url, userAgent, body, contentType, encode, selfSigned, syncCookie);
    }

    public String execHead(String url) throws IOException {
        return exec(Method.HEAD, url, userAgent, null, contentType, encode, selfSigned, syncCookie);
    }
    ...
    private static String exec(Method method, String url, String userAgent, String body,
